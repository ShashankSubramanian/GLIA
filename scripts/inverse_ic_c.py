...
p['p_seg_path']     = os.path.join(code_dir, 'syndata/case%d/160/seg_t1.nc'%syn)
p['p_vt_path']      = "" 
...
p['nt_inv']         = 80                        # number time steps for inversion
p['dt_inv']         = 0.0125                      # time step size for inversion
