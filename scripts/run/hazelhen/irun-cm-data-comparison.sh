...
DSET=obs-train
OFF=${BRATS}/results/HGG-grid-cont/concomp-obs-1.0_01/
OBS_REF='obs-1.0'
...
for ID in  Brats18_CBICA_AQJ_1  Brats18_TCIA03_257_1 Brats18_TCIA04_328_1
do
...
aprun -n 96 -N 24  ${CODE_DIR}/inverse -nx 256 -ny 256 -nz 256 -beta 0.0001 \
   ...
   _newton_solver QN -line_search armijo  -newton_maxit 50 -gist_maxit 2 -krylov_maxit 30 -rel_grad_tol 1e-04 -syn_flag 0                                                                                 \
   -tao_lmm_vectors 50 -tao_lmm_scale_type broyden -tao_lmm_scalar_history 5 -tao_lmm_rescale_type scalar -tao_lmm_rescale_history 5 -tumor_tao_ls_max_funcs 10 -tao_ls_max_funcs 10 \
