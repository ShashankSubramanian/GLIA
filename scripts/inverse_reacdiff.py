...
p['output_dir']     = os.path.join(code_dir, 'results/inv_ed_160/');                      # results path
p['d0_path']        = os.path.join(code_dir, 'syndata/160/c0Recon_transported.nc')
p['d1_path']        = os.path.join(code_dir, 'syndata/160/ed_inv/data_t1.nc')
p['atlas_labels']   = "[wm=6,gm=5,vt=7,csf=8,ed=2,nec=1,en=4]"                                   
p['a_seg_path']     = os.path.join(code_dir, 'syndata/160/seg_t1.nc')
p['mri_path']       = "" 
...
p['gamma_lb']       = 1E4                         # lower bound gamma
p['gamma_ub']       = 1E5                      # upper bound gamma
