...
if __name__=='__main__':
    ...
    patient_name    = "Brats18_CBICA_AMH_1"
    ...
    results_path = scripts_path + "/../results/reg-Brats18_CBICA_AMH_1/"
    ...
    for i in atlist:
        ...
        bash_file = register(claire_path, r_path, atlas, bash_file, i, multigpu=True)
    ...
    for i in atlist:
        ...
        bash_file = transport(claire_path, r_path, bash_file, "c0Recon", i, multigpu=True)
        bash_file = transport(claire_path, r_path, bash_file, "patient_vt", i, multigpu=True)
