...
#pat_names = ["atlas-2-case2"]
scripts_path = os.getcwd() + "/.."
idx = 0
for n in pat_names:
  data_path = scripts_path + "/../results/" + n + "/reg/"
  pnm = pat_names[idx]
  for at in os.listdir(data_path):
    if at[0] == "5":
      atlas = at
      r_path = data_path + atlas
      atlas_path = scripts_path + "/../../data/adni/" + atlas + "_seg_aff2jakob_ants.nii.gz"
