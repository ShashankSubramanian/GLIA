...
def create_tusolver_config(pat_dir, res_dir, forward_params, is_syn, v_dir, n):
  ...
  p['d0_path'] = os.path.join(v_dir, 'c0_true_syn.nc')
  p['d1_path'] = ""
...
def create_tusolver_config_temp(pat_dir, res_dir, forward_params, is_syn, v_dir, n, temp_seg):
