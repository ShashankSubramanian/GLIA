#!/bin/bash
#SBATCH -J ITP
#SBATCH -o /workspace/shashank/pglistr_tumor/scripts/..//results/check_reac_tol1E-3//log
#SBATCH -p rebels
#SBATCH -N 1
#SBATCH -n 20
#SBATCH -t 48:00:00
