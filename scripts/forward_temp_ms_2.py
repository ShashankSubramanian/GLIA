...
res_dir = '/scratch1/07544/ghafouri/results/syn_results/inv_p_temp_m/'
fwd_me_dir = '/scratch1/07544/ghafouri/results/syn_results/inv_p_temp_m/'
...
for pat in pat_list:
  ...
  for j in lines:
    ...
    at = j.strip('\n')
    p['output_dir'] = os.path.join(res_dir, pat, 'fwd_ms', at);            # results path
    ...
    p['output_dir'] = os.path.join(inv_pat_dir, pat, 'fwd_ms', at+'/');
    p['a_gm_path'] = ""
    p['a_wm_path'] = ""
    p['a_csf_path'] = ""
    p['a_vt_path'] = ""
    ...
    cmd = 'python multispecies/extract_params.py -results_path '+os.path.join(res_dir, pat, 'ms_inv', at)
    print(cmd)
    os.system(cmd) 
    recon_file=os.path.join(res_dir, pat, 'ms_inv', at, 'recon_info.dat')
