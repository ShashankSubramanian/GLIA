...
############### === define parameters
p['output_dir'] 		= os.path.join(code_dir, 'results/inv-atlas-2-case3-hp-c0/');   		# results path
p['d1_path'] 			  = code_dir + '/results/atlas-2-tu-case3/c_final.nc'			# tumor data path
#p['d0_path'] 			  = code_dir + '/results/atlas-2-tu-case3/c0_true_syn.nc'			# tumor data path
p['d0_path']        = code_dir + '/results/rd-atlas-2-case3/tumor_inversion/nx256/obs-1.0/c0Recon.nc'
#p['d0_path']            = code_dir + '/results/reg-atlas-2-case3/atlas-2/c0Recon_transported.nc'                   # path to initial condition for tumor
