...
############### === define parameters
p['output_dir'] 		= os.path.join(code_dir, 'results/inv-t16-cas6/');   		# results path
p['d1_path'] 			  = code_dir + '/results/miccai/t16-case6/c_final.nc'			# tumor data path
...
p['p_wm_path'] 			= code_dir + '/results/miccai/t16-case6/wm_final.nc'            # patient brain data path
p['p_gm_path'] 			= code_dir + '/results/miccai/t16-case6/gm_final.nc'
p['p_csf_path'] 		= code_dir + '/results/miccai/t16-case6/csf_final.nc'
p['p_vt_path'] 			= code_dir + '/results/miccai/t16-case6/vt_final.nc'
...
p['gaussian_cm_path']   = code_dir + '/results/miccai/t16-case6/phi-mesh-forward.txt'                       
p['pvec_path']          = code_dir + '/results/miccai/t16-case6/p-rec-forward.txt'                        # path to initial guess p vector (if none, use zero)
