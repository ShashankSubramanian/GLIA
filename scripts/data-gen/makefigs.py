...
if __name__=='__main__':
    ...
    for index, row in test_df.iterrows():
        ...
        try:
            ...
            for img, capt, fname in zip([abnormal, pred, normal, orig], ['abnormal (syn)', 'normal (pred)', 'normal (true)', 'abnormal (brats)'],
                ['abnormal_syn_'+prefix+'_ax-slice-'+str(z), 'normal_pred_'+prefix+'_ax-slice-'+str(z),'normal_true_'+prefix+'_ax-slice-'+str(z), 'abnormal_brats_'+prefix+'_ax-slice-'+str(z)]):
            ...
            for img, capt, fname in zip([abnormal, pred, normal, orig], ['abnormal (syn)', 'normal (pred)', 'normal (true)', 'abnormal (brats)'],
                ['abnormal_syn_'+prefix+'_sag-slice-'+str(x), 'normal_pred_'+prefix+'_sag-slice-'+str(x),'normal_true_'+prefix+'_sag-slice-'+str(x), 'abnormal_brats_'+prefix+'_sag-slice-'+str(x)]):
                aax = fig.add_subplot(1, 1, 1);
                aax.tick_params(axis='both', which='both', bottom=False, top=False, left=False, labelleft=False, labelbottom=False);
            ...
            for img, capt, fname in zip([abnormal, pred, normal, orig], ['abnormal (syn)', 'normal (pred)', 'normal (true)', 'abnormal (brats)'],
                ['abnormal_syn_'+prefix+'_cor-slice-'+str(y), 'normal_pred_'+prefix+'_cor-slice-'+str(y),'normal_true_'+prefix+'_cor-slice-'+str(y), 'abnormal_brats_'+prefix+'_cor-slice-'+str(y)]):
                aax = fig.add_subplot(1, 1, 1);
                aax.tick_params(axis='both', which='both', bottom=False, top=False, left=False, labelleft=False, labelbottom=False);
            ...
            print("Error processing {}.".format(patient), e)
