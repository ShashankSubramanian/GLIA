...
PetscErrorCode sigmoid (Vec temp, Vec input) {
    PetscFunctionBegin;
    PetscErrorCode ierr = 0;
...
PetscErrorCode DerivativeOperatorsPos::evaluateHessian (Vec y, Vec x){   //TODO : Include the point at which hessian is evaluated
    PetscFunctionBegin;
    PetscErrorCode ierr = 0;
