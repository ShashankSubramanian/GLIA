...
PetscErrorCode operatorConstantCoefficients (Mat A, Vec x, Vec y) {
    ...
    accfft_execute_c2r (n_misc->plan, ux_hat, ux_ptr);
    accfft_execute_c2r (n_misc->plan, uy_hat, uy_ptr);
    accfft_execute_c2r (n_misc->plan, uz_hat, uz_ptr);
