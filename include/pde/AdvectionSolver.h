...
class AdvectionSolver {
 public:
  AdvectionSolver(std::shared_ptr<Parameters> params, std::shared_ptr<Tumor> tumor, std::shared_ptr<SpectralOperators> spec_ops);  // tumor is needed for its work vectors
...
class TrapezoidalSolver : public AdvectionSolver {
 public:
  ...
  TrapezoidalSolver(std::shared_ptr<Parameters> params, std::shared_ptr<Tumor> tumor, std::shared_ptr<SpectralOperators> spec_ops);
...
class ImplicitEulerSolver : public AdvectionSolver {
 public:
  ...
  ImplicitEulerSolver(std::shared_ptr<Parameters> params, std::shared_ptr<Tumor> tumor, std::shared_ptr<SpectralOperators> spec_ops);
  virtual PetscErrorCode solve(Vec scalar, std::shared_ptr<VecField> velocity, ScalarType dt);
...
class SemiLagrangianSolver : public AdvectionSolver {
 public:
  SemiLagrangianSolver(std::shared_ptr<Parameters> params, std::shared_ptr<Tumor> tumor, std::shared_ptr<SpectralOperators> spec_ops);
